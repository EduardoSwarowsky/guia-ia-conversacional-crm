...
[Anterior: Mapa das tecnologias](/docs/02-mapa-das-tecnologias.md) ·
[Início](/) · [Próximo: Dados e CRM](/docs/04-dados-e-crm.md)
...
Exemplos relacionados: [fluxo API, chat e IA](/docs/exemplos-de-integracao.md#fluxo-api-chat-e-ia) e [gateway de IA](/docs/exemplos-de-integracao.md#gateway-de-ia).

[Próximo: Dados e CRM](/docs/04-dados-e-crm.md)
