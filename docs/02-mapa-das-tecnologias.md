...
[Anterior: Visão geral](/docs/01-visao-geral.md) · [Início](/) ·
[Próximo: Chatbot e IA](/docs/03-chatbot-e-ia.md)
...
Exemplo relacionado: [gateway de IA](/docs/exemplos-de-integracao.md#gateway-de-ia).
...
Exemplo relacionado: [consulta para dashboard](/docs/exemplos-de-integracao.md#consulta-para-dashboard).
