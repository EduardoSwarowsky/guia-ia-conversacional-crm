...
Exemplo relacionado: [gateway de IA](exemplos-de-integracao.md#gateway-de-ia).
...
Exemplo relacionado: [consulta para dashboard](exemplos-de-integracao.md#consulta-para-dashboard).
